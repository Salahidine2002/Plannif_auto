(define (problem nonogram_3x3_conf2)
  (:domain nonogram)
  (:objects
  ...
  (:goal
    (and
      ; Column 1 should have 1 cell colored
      ...
      ; Two non adjav=cent cells colored in column 2
      (exists (?cell1 ?cell2 ?cell3)
        (and
          (filled ?cell1) (marked ?cell2) (filled ?cell3)
          (in-col ?cell1 col2) (in-col ?cell2 col2) (in-col ?cell3 col2)
          (not(adjacent ?cell1 ?cell3))
        )
      )
      ...
      (exists (?cell1 ?cell2 ?cell3)
        (and
          (filled ?cell1) (marked ?cell2) (marked ?cell2)
      ...
      ; Two non adjacent cells colored in line 2
      (exists (?cell1 ?cell2 ?cell3)
        (and
      ...
      ; one cell colored in line 3
      (exists (?cell1 ?cell2 ?cell3)
        (and
          (filled ?cell1) (marked ?cell2) (marked ?cell3)
          (in-row ?cell1 row3) (in-row ?cell2 row23) (in-row ?cell3 row3)
        )
      )
    )
  )
