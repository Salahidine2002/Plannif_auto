...
# python -B -m pddl_parser.PDDL ../pddl-parser/examples/dinner/dinner.pddl ../pddl-parser/examples/dinner/pb1.pddl
# python -B -m pddl_parser.PDDL Group1/domain_lights_out.pddl Group1\problems\lights_size3x3_conf1.pddl
# python -B -m pddl_parser.planner hanoi/domain_hanoi.pddl hanoi/problem_hanoi.pddl 
# python -B -m pddl_parser.PDDL ../problems/domain_miconic.pddl ../problems/problem_miconic.pddl