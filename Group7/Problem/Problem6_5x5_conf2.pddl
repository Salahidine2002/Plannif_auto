(define (problem nonogram_5x5_conf2)
  ...
  (:goal
    (and
      ...
      ; Two adjacent cells colored in column 3
      (exists (?cell1 ?cell2 ?cell3 ?cell4 ?cell5)
        (and
      ...
      ; Two adjacent cells colored in column 5
      (exists (?cell1 ?cell2 ?cell3 ?cell4 ?cell5)
        (and
          (filled ?cell1) (filled ?cell2) (marked ?cell3) (marked ?cell4) (marked ?cell5)
      ...
      ; row 2 should have 3 adjacent cells colored
      (exists (?cell1 ?cell2 ?cell3 ?cell4 ?cell5)
        (and
          (filled ?cell1) (filled ?cell2) (filled ?cell3) (marked ?cell4) (marked ?cell5)
      ...
      ; row 3 should have 2 adjacent cells colored
      (exists (?cell1 ?cell2 ?cell3 ?cell4 ?cell5)
        (and
          (filled ?cell1) (filled ?cell2) (marked ?cell3) (marked ?cell4) (marked ?cell5)
      ...
      ; One then two cells colored in line 5
      (exists (?cell1 ?cell2 ?cell3 ?cell4 ?cell5)
        (and
          (filled ?cell1) (filled ?cell2) (filled ?cell3) (marked ?cell4) (marked ?cell5)
          (in-row ?cell1 row5) (in-row ?cell2 row5) (in-row ?cell3 row5) (in-row ?cell4 row5) (in-row ?cell5 row5)
          (adjacent ?cell2 ?cell3) (not(adjacent ?cell1 ?cell2)) (not(adjacent ?cell1 ?cell3))
        )
      )
    )
  )
