...
def make_node_dic(action, action_properties, no_op=False):
    ...
    """
    preconditions = set(action_properties[0]) | set([~p for p in action_properties[1]])
    effects = set(action_properties[2]) | set([~e for e in action_properties[3]])
